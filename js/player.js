                ...
                value: function(e, t, r, n) {
                    ...
                    return this.prepareDraw(e, t, r, n, function(e) {
                        var t = e.absmax,
                            ...
                            u = e.peaks;
                        if (void 0 !== r)
                            for (var l = a ? 2 : 1, c = u.length / l, h = i.params.barWidth * i.params.pixelRatio, f = h + (null === i.params.barGap ? Math.max(i.params.pixelRatio, ~~(h / 2)) : Math.max(i.params.pixelRatio, i.params.barGap * i.params.pixelRatio)), d = c / i.width, p = n, v = r; v < p; v += f) {
